...
namespace Armageddon.GameLogic.Character {
    ...
    public class ClassicController : ACharacter {
        ...
        protected new void Update() {
            ...
            if (actions.GenericCharacter.Rotate.IsPressed()) AddRotation(actions.GenericCharacter.Rotate.ReadValue<float>() * Time.deltaTime * 25f); //TODO: Use proper sensitivity settings
            if (actions.GenericCharacter.Charge.IsPressed()) CurrentCharge += actions.GenericCharacter.Charge.ReadValue<float>() * Time.deltaTime * 25f; //TODO: Use proper sensitivity settings
        }
